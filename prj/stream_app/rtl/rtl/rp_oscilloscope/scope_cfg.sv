...
// Port a Release_2026.1: bloque de registros propio movido de 0x200-0x248 a
// 0x300-0x348 — 2026.1 agrego TIMESTAMP_INIT/BUFx_TIMESTAMP en 0x200-0x214.
localparam BP_COEFF_B0_S0           = 12'h300;
localparam BP_COEFF_B1_S0           = 12'h304;
localparam BP_COEFF_B2_S0           = 12'h308;
localparam BP_COEFF_A1_S0           = 12'h30C;
localparam BP_COEFF_A2_S0           = 12'h310;
localparam BP_COEFF_B0_S1           = 12'h314;
localparam BP_COEFF_B1_S1           = 12'h318;
localparam BP_COEFF_B2_S1           = 12'h31C;
localparam BP_COEFF_A1_S1           = 12'h320;
localparam BP_COEFF_A2_S1           = 12'h324;

// Etapa 5 (RedPitaya-FPGA): area/kurtosis por ventana
localparam AREA_WINDOW_SAMPLES       = 12'h328; // R/W - muestras por ventana
localparam AREA_WINDOW_COUNT         = 12'h32C; // R   - se incrementa por ventana completa
localparam AREA_SUM_ABS_LO           = 12'h330; // R
localparam AREA_SUM_ABS_HI           = 12'h334; // R
localparam AREA_SUM_X2_LO            = 12'h338; // R
localparam AREA_SUM_X2_HI            = 12'h33C; // R
