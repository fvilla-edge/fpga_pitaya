#!/usr/bin/env python3
"""Compara los resultados de tb_area_kurtosis_lote2_simD.sv (resultado_N.json
en xsim_simD_lote2/) contra la referencia de software (lote2_simD/referencia_N.json)."""
import json
...
XSIM_DIR = HERE / ".." / ".." / "xsim_simD_lote2"
LOTE_DIR = HERE / "lote2_simD"
