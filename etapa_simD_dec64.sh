...
# tbn/vectores/extraer_dec64_simD.py. Ver tb_area_kurtosis_dec64_simD.sv.
set -e
cd "$(dirname "$0")"
...
rm -rf xsim_dec64_simD xsim.dir
mkdir -p xsim_dec64_simD
cd xsim_dec64_simD
...
xvlog -sv \
  ...
  ../tbn/tb_area_kurtosis_dec64_simD.sv

xelab -debug typical tb_area_kurtosis_dec64_simD -s tb_area_kurtosis_dec64_simD_sim -timescale 1ns/1ps

xsim tb_area_kurtosis_dec64_simD_sim -runall
